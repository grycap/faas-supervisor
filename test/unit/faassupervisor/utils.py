...
from faassupervisor.utils import SysUtils, StrUtils, FileUtils, ConfigUtils, OIDCUtils
...
class OIDCUtilsTest(unittest.TestCase):
    ...
    def test_is_access_token_expired(self):
        token = ("eyJraWQiOiJyc2ExIiwiYWxnIjoiUlMyNTYifQ.eyJzdWIiOiJkYzVkNWFiNy02ZGI5LTQwNzktOTg1Yy04MGFjMDUwMTcw"
                 ...
                 "IwQ3JBz9azBT1o_oAHE5BsPsE2BjfDoVRasZxxW5UoXCmBslonYd8HK2tUVjz0")  # nosec
        assert OIDCUtils.is_access_token_expired(token)
